...
min_coverage = 5
min_clade_length = -1  #[WH]change to no cutoff for min coexistence time [20180409]
...
for population in populations:
    ...
    for mutation_idx in xrange(0,len(mutation_data)):
        ...
        #print num_good_timepoints  #[WH]
        #print depths #[WH]
        #print masked_depths #[WH]
        #print mutation_data[mutation_idx] #[WH]
    ...
    #print good_mutations  #[WH]

    try: #[WH] add try feature
    #if True: #[WH]
    
        # Run HMM decode
        # estimates clade frequencies from scratch
        Pstate, Ls, fmajors, fminors = clade_model.infer_hmm(A,D,num_iterations=50) #[WH] change num_iterations =5 to =50             
        ...
        Pstate , Ls, fmajors, fminors = clade_model.infer_hmm(A,D,f0s=(fmajors,fminors),num_iterations=50,infer_fs=False)  #[WH20190403] change num_iterations =5 to =50             
