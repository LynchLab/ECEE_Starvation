...
data_directory='/Users/wei-chinho/Documents/MURI2/00_data/server/weiho/annotated_timecourse/'#data_directory='/Users/wei-chinho/Documents/MURI2/00_data/server/weiho/annotated_timecourse/'#data_directory='data_files/' 
figure_directory='./'#figure_directory='manuscript/figures/'
...
#all_lines = ['217']
#all_lines = ['m6_cut']#all_lines = ['m5','p2','p4','p1','m6','p5','m1','m2','m3','m4','p3','p6']
all_lines = []
for a in range(1,6):
   for b in range(1,25):
        if (a*100+b) != 208 and (a*100+b) != 224:
            all_lines.append(str(a*100+b))
...
line_color_map = {'101': '#4A1486', '102': '#807DBA', '103': '#084594','104': '#4292C6','m5': '#4A1486', 'p2': '#807DBA', 'p4': '#084594','p1': '#4292C6', 'p5': '#005A32', 'm6': '#41AB5D', 'm1': '#8C2D04', 'm2': '#CC4C02', 'm3': '#B10026', 'm4': '#E31A16', 'p3': '#FC4E2A', 'p6': '#FD8D3C'}
