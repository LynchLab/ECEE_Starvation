...
nonmutator_populations = ['101','102']#nonmutator_populations = ['m5','p2','p4','p1','m6','p5']
mutator_populations = ['103','104']#mutator_populations = ['m1','m2','m3','m4','p3','p6']
#nonmutator_populations = []  #[WH]
#for a in range(1,6): #[WH]
#   for b in range(1,25): #[WH]
#       nonmutator_populations.append(str(a*100+b)) #[WH]

#population_labels = {population: parse_file.get_pretty_name(population) for population in nonmutator_populations}
population_labels = { population: population for population in nonmutator_populations }
...
for i in xrange(0,len(mutator_populations)):
    ...
    population_labels[mutator_populations[i]] = mutator_populations[i]
