...
def infer_hmm(A, D, f0s=None, num_iterations=10, penalize_clades=True, infer_fs=True, debug=False):
    ...
    if estimate_f0:
        ...
        print ("interp1d: sum of good_majority_idxs=" + str(sum(good_majority_idxs)))#[WH] print number of good idx; 0 causes problem  [20180409]
        print ("interp1d: sum of good_minority_idxs=" + str(sum(good_minority_idxs)))
